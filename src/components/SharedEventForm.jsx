...
export default function SharedEventForm({ selectedDate, onFormSubmit, onCancel, isShared, user }) {
      ...
      <div className="bg-white border-4 border-black rounded-xl neo-shadow p-6 w-full max-w-md">
        <div className="flex justify-between items-center mb-4">
          <h3 className="text-2xl font-bold">
            Add {isShared ? "Shared" : "Personal"} Event
          </h3>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input 
              ...
              placeholder={isShared ? "e.g. Math Test - Chapter 5" : "e.g. Study Session"}
              autoFocus
            />
          </div>
        ...
        {isShared && (
          <p className="text-xs text-gray-600 mt-3 text-center">
            This event will be visible to your entire class
          </p>
        )}
      </div>
    </motion.div>
